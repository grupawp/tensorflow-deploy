...
func (*SSLConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_ssl_config_f4714e819548e772, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/ssl_config.proto", fileDescriptor_ssl_config_f4714e819548e772)
}

var fileDescriptor_ssl_config_f4714e819548e772 = []byte{
