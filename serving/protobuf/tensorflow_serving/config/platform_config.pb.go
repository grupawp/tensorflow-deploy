...
func (*PlatformConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_platform_config_082bb79c47d60dc4, []int{0}
}
...
func (*PlatformConfigMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_platform_config_082bb79c47d60dc4, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/platform_config.proto", fileDescriptor_platform_config_082bb79c47d60dc4)
}

var fileDescriptor_platform_config_082bb79c47d60dc4 = []byte{
