...
func (*SamplingConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_logging_config_ef96cd62fcae67fb, []int{0}
}
...
func (*LoggingConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_logging_config_ef96cd62fcae67fb, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/logging_config.proto", fileDescriptor_logging_config_ef96cd62fcae67fb)
}

var fileDescriptor_logging_config_ef96cd62fcae67fb = []byte{
