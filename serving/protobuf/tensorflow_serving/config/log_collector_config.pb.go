...
func (*LogCollectorConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_collector_config_58501bad471d48d0, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/log_collector_config.proto", fileDescriptor_log_collector_config_58501bad471d48d0)
}

var fileDescriptor_log_collector_config_58501bad471d48d0 = []byte{
