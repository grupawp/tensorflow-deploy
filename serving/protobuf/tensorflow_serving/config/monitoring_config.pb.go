...
func (*PrometheusConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_monitoring_config_b618fce849ced4c3, []int{0}
}
...
func (*MonitoringConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_monitoring_config_b618fce849ced4c3, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/monitoring_config.proto", fileDescriptor_monitoring_config_b618fce849ced4c3)
}

var fileDescriptor_monitoring_config_b618fce849ced4c3 = []byte{
