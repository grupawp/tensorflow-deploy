...
import fmt "fmt"
import math "math"
import util "github.com/grupawp/tensorflow-deploy/serving/protobuf/tensorflow_serving/util"
...
func (ModelVersionStatus_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_b991b547a9b534ac, []int{1, 0}
}
...
func (*GetModelStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_b991b547a9b534ac, []int{0}
}
...
func (*ModelVersionStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_b991b547a9b534ac, []int{1}
}
...
func (*GetModelStatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_b991b547a9b534ac, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/get_model_status.proto", fileDescriptor_get_model_status_b991b547a9b534ac)
}

var fileDescriptor_get_model_status_b991b547a9b534ac = []byte{
