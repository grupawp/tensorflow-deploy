...
import protobuf "github.com/grupawp/tensorflow-deploy/serving/protobuf/tensorflow/core/protobuf"
...
func (*SignatureDefMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_metadata_a0a2cc6e1c624abb, []int{0}
}
...
func (*GetModelMetadataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_metadata_a0a2cc6e1c624abb, []int{1}
}
...
func (*GetModelMetadataResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_metadata_a0a2cc6e1c624abb, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/get_model_metadata.proto", fileDescriptor_get_model_metadata_a0a2cc6e1c624abb)
}

var fileDescriptor_get_model_metadata_a0a2cc6e1c624abb = []byte{
