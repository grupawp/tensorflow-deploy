...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/model_service.proto", fileDescriptor_model_service_711a6fa8b0c9d1ef)
}

var fileDescriptor_model_service_711a6fa8b0c9d1ef = []byte{
