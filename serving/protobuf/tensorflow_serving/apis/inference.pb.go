...
func (*InferenceTask) Descriptor() ([]byte, []int) {
	return fileDescriptor_inference_195525dd9ec3c1b2, []int{0}
}
...
func (*InferenceResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_inference_195525dd9ec3c1b2, []int{1}
}
...
func (*MultiInferenceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_inference_195525dd9ec3c1b2, []int{2}
}
...
func (*MultiInferenceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_inference_195525dd9ec3c1b2, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/inference.proto", fileDescriptor_inference_195525dd9ec3c1b2)
}

var fileDescriptor_inference_195525dd9ec3c1b2 = []byte{
