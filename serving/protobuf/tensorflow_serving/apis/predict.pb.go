...
func (*PredictRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_predict_27a656412cd7ff05, []int{0}
}
...
func (*PredictResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_predict_27a656412cd7ff05, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/predict.proto", fileDescriptor_predict_27a656412cd7ff05)
}

var fileDescriptor_predict_27a656412cd7ff05 = []byte{
