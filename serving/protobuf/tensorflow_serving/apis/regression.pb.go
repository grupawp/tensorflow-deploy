...
func (*Regression) Descriptor() ([]byte, []int) {
	return fileDescriptor_regression_a7a997d4f2e3b618, []int{0}
}
...
func (*RegressionResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_regression_a7a997d4f2e3b618, []int{1}
}
...
func (*RegressionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_regression_a7a997d4f2e3b618, []int{2}
}
...
func (*RegressionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_regression_a7a997d4f2e3b618, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/regression.proto", fileDescriptor_regression_a7a997d4f2e3b618)
}

var fileDescriptor_regression_a7a997d4f2e3b618 = []byte{
