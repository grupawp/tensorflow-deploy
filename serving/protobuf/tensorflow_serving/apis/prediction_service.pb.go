...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/prediction_service.proto", fileDescriptor_prediction_service_ca66320c8ae33872)
}

var fileDescriptor_prediction_service_ca66320c8ae33872 = []byte{
