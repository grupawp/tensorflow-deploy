...
import fmt "fmt"
import math "math"
import config "github.com/grupawp/tensorflow-deploy/serving/protobuf/tensorflow_serving/config"
...
func (*ReloadConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_management_446b1efd84ceefe2, []int{0}
}
...
func (*ReloadConfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_management_446b1efd84ceefe2, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/model_management.proto", fileDescriptor_model_management_446b1efd84ceefe2)
}

var fileDescriptor_model_management_446b1efd84ceefe2 = []byte{
