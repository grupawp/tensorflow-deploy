...
func (*Config1) Descriptor() ([]byte, []int) {
	return fileDescriptor_class_registration_test_3a47acf63966620c, []int{0}
}
...
func (*Config2) Descriptor() ([]byte, []int) {
	return fileDescriptor_class_registration_test_3a47acf63966620c, []int{1}
}
...
func (*MessageWithAny) Descriptor() ([]byte, []int) {
	return fileDescriptor_class_registration_test_3a47acf63966620c, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/util/class_registration_test.proto", fileDescriptor_class_registration_test_3a47acf63966620c)
}

var fileDescriptor_class_registration_test_3a47acf63966620c = []byte{
