...
package example // import "github.com/grupawp/tensorflow-deploy/serving/protobuf/tensorflow/core/example"
...
func (*VarLenFeatureProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_301bd8162d2b2408, []int{0}
}
...
func (*FixedLenFeatureProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_301bd8162d2b2408, []int{1}
}
...
func (*FeatureConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_301bd8162d2b2408, []int{2}
}
...
func (*ExampleParserConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_301bd8162d2b2408, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/example/example_parser_configuration.proto", fileDescriptor_example_parser_configuration_301bd8162d2b2408)
}

var fileDescriptor_example_parser_configuration_301bd8162d2b2408 = []byte{
