...
func (SaverDef_CheckpointFormatVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_saver_b4214e0685a31dd0, []int{0, 0}
}
...
func (*SaverDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_saver_b4214e0685a31dd0, []int{0}
}
...
func (dst *SaverDef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SaverDef.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/saver.proto", fileDescriptor_saver_b4214e0685a31dd0)
}

var fileDescriptor_saver_b4214e0685a31dd0 = []byte{
