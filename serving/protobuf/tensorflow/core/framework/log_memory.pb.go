...
func (*MemoryLogStep) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_ab5bbc3f6c18271d, []int{0}
}
...
func (*MemoryLogTensorAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_ab5bbc3f6c18271d, []int{1}
}
...
func (*MemoryLogTensorDeallocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_ab5bbc3f6c18271d, []int{2}
}
...
func (*MemoryLogTensorOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_ab5bbc3f6c18271d, []int{3}
}
...
func (*MemoryLogRawAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_ab5bbc3f6c18271d, []int{4}
}
...
func (*MemoryLogRawDeallocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_ab5bbc3f6c18271d, []int{5}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/log_memory.proto", fileDescriptor_log_memory_ab5bbc3f6c18271d)
}

var fileDescriptor_log_memory_ab5bbc3f6c18271d = []byte{
