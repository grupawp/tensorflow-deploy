...
func (*TensorShapeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_shape_62325a1e75b76dc9, []int{0}
}
...
func (*TensorShapeProto_Dim) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_shape_62325a1e75b76dc9, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_shape.proto", fileDescriptor_tensor_shape_62325a1e75b76dc9)
}

var fileDescriptor_tensor_shape_62325a1e75b76dc9 = []byte{
