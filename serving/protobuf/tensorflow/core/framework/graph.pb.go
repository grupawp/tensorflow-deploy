...
func (*GraphDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_graph_0be1d30226a2ceaf, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/graph.proto", fileDescriptor_graph_0be1d30226a2ceaf)
}

var fileDescriptor_graph_0be1d30226a2ceaf = []byte{
