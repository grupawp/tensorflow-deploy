...
func (*VariableDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_variable_43d4bf74cc34c844, []int{0}
}
...
func (*SaveSliceInfoDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_variable_43d4bf74cc34c844, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/variable.proto", fileDescriptor_variable_43d4bf74cc34c844)
}

var fileDescriptor_variable_43d4bf74cc34c844 = []byte{
