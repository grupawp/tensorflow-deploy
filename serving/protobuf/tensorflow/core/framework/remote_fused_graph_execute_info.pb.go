...
func (*RemoteFusedGraphExecuteInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_remote_fused_graph_execute_info_88e951fcf912b207, []int{0}
}
...
func (*RemoteFusedGraphExecuteInfo_TensorShapeTypeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_remote_fused_graph_execute_info_88e951fcf912b207, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/remote_fused_graph_execute_info.proto", fileDescriptor_remote_fused_graph_execute_info_88e951fcf912b207)
}

var fileDescriptor_remote_fused_graph_execute_info_88e951fcf912b207 = []byte{
