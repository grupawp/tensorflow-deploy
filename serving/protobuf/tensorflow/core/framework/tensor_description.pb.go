...
func (*TensorDescription) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_description_851ce79fcc229e9c, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_description.proto", fileDescriptor_tensor_description_851ce79fcc229e9c)
}

var fileDescriptor_tensor_description_851ce79fcc229e9c = []byte{
