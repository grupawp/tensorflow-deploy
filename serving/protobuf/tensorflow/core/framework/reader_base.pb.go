...
func (*ReaderBaseState) Descriptor() ([]byte, []int) {
	return fileDescriptor_reader_base_1a318352792c7130, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/reader_base.proto", fileDescriptor_reader_base_1a318352792c7130)
}

var fileDescriptor_reader_base_1a318352792c7130 = []byte{
