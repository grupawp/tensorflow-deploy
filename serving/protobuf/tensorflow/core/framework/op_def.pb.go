...
func (*OpDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_aa512dfb84289bb9, []int{0}
}
...
func (*OpDef_ArgDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_aa512dfb84289bb9, []int{0, 0}
}
...
func (*OpDef_AttrDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_aa512dfb84289bb9, []int{0, 1}
}
...
func (*OpDeprecation) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_aa512dfb84289bb9, []int{1}
}
...
func (*OpList) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_aa512dfb84289bb9, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/op_def.proto", fileDescriptor_op_def_aa512dfb84289bb9)
}

var fileDescriptor_op_def_aa512dfb84289bb9 = []byte{
