...
func (*VersionDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_versions_91174ee7d43dec80, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/versions.proto", fileDescriptor_versions_91174ee7d43dec80)
}

var fileDescriptor_versions_91174ee7d43dec80 = []byte{
